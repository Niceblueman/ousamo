    ...
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-300">{t("contact.subtitle")}</p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">{t("contact.phone")}</h3>
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">{t("contact.email")}</h3>
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">{t("contact.address")}</h3>
